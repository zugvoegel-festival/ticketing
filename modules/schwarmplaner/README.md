...
- `default.nix` — `zugvoegel.services.schwarmplaner` options, multi-instance containers, nginx vhosts, `schwarmplaner-deploy-backup` helper, shared `deploy` user wiring
